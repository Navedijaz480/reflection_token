...
contract ReflectionToken is Context, IERC20, Ownable {
    ...
    function changeRouterAddress(address adr) public onlyOwner{
       uniswapV2Router = IUniswapV2Router02(adr);
       createPair(uniswapV2Router);
    }
    function createPair(IUniswapV2Router02 adr) internal{
       uniswapV2Pair = IUniswapV2Factory(adr.factory())
            .createPair(address(this), adr.WETH());
    }
